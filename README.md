Вот обновлённый и улучшенный вариант файла `README.md`, который включает все необходимые разделы, структурированную информацию и улучшенное описание функционала вашего проекта.
